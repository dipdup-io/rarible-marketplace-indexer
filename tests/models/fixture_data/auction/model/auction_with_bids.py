...
auction_model = AuctionModel(
            ...
            last_bid_amount=AssetValue(1),
            last_bid_bidder=ImplicitAccountAddress('tz1Mxsc66En4HsVHr6rppYZW82ZpLhpupToC'),
            last_bid_date=datetime(2022, 5, 2, 16, 33, 35, tzinfo=UTC),
        )
