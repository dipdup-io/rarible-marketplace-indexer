...
class RaribleApiAuctionActivityFactory:
    @classmethod
    def _build_start_auction_activity(cls, activity: AuctionActivityModel) -> RaribleApiAuctionStartActivity:
    ...
    def _get_factory_method(cls, activity: AuctionActivityModel) -> callable:
        method_map: Dict[ActivityTypeEnum, Callable[[AuctionActivityModel], callable]] = {
            ActivityTypeEnum.AUCTION_STARTED: cls._build_start_auction_activity,
        ...
        return method_map.get(activity.type, cls._build_start_auction_activity)
